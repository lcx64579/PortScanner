...
QT_MOC_LITERAL(4, 24, 6), // "status"
QT_MOC_LITERAL(5, 31, 4), // "text"
QT_MOC_LITERAL(6, 36, 11), // "cleanStatus"
QT_MOC_LITERAL(7, 48, 6), // "finish"
QT_MOC_LITERAL(8, 55, 4), // "scan"
QT_MOC_LITERAL(9, 60, 4), // "host"
QT_MOC_LITERAL(10, 65, 9), // "startPort"
QT_MOC_LITERAL(11, 75, 7), // "endPort"
QT_MOC_LITERAL(12, 83, 7) // "timeout"

    },
    "Scanner\0progress\0\0value\0status\0text\0"
    "cleanStatus\0finish\0scan\0host\0startPort\0"
    "endPort\0timeout"
};
...
void Scanner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->cleanStatus(); break;
        case 3: _t->finish(); break;
        case 4: _t->scan((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        default: ;
        }
        ...
        {
            typedef void (Scanner::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scanner::progress)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Scanner::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scanner::status)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scanner::cleanStatus)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Scanner::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Scanner::finish)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject Scanner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Scanner.data,
      qt_meta_data_Scanner,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Scanner::progress(const int & _t1)
{
...
// SIGNAL 1
void Scanner::status(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
